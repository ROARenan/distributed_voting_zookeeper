set ZK="/home/roa/Desktop/code/final_zookeeper/apache-zookeeper-3.9.3"
...
java -cp %CP_ZK% -Dlogback.configurationFile=file:%ZK%\conf\logback.xml SyncPrimitive localhost